...
const SLIDES = [
  {
    ...
    subtitle: 'Start here',
    description: 'Pick any AI engine — Gemini, FLUX, GPT Image, Ideogram — and generate images instantly. No setup required.',
    cta: { label: 'Try Freestyle', workspace: 'generate', mode: 'create' },
  },
  {
    icon: <Users className="w-7 h-7" />,
    accent: '#FFB347',
    title: 'Director Studio',
    subtitle: 'Build your character',
    description: 'Upload 1–3 face photos, define outfit and traits, then generate consistent images of your AI character across any scene.',
    cta: { label: 'Open Director', workspace: 'director' },
  },
  {
    icon: <Zap className="w-7 h-7" />,
    accent: '#FF7A5A',
    title: 'Library & Storyboard',
    subtitle: 'Organize & plan',
    description: 'Save characters to your library, collect generated images, and plan content campaigns in the storyboard.',
    cta: { label: 'View Library', workspace: 'characters' },
  },
];
