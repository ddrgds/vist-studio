...
const GalleryGrid: React.FC<GalleryGridProps> = ({
  ...
  const { filteredHistory, generatedHistory, selectedIds, clearSelection, batchDeleteItems, isSelectionMode, addItems, filterType, setFilterType, sortOrder, setSortOrder } = useGallery();
