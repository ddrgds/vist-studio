...
const CaptionModal: React.FC<CaptionModalProps> = ({ imageUrl, onClose }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      addToast(err?.message || 'Error generating caption', 'error');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 shrink-0" style={{ borderBottom: '1px solid var(--joi-border)' }}>
          <div className="flex items-center gap-2.5">
            ...
            <h2 className="text-sm font-semibold" style={{ color: 'var(--joi-text-1)' }}>Caption Generator</h2>
          </div>
        ...
        <div className="overflow-y-auto flex-1 p-5 space-y-4 joi-scroll">
          ...
          {/* Platform selector */}
          <div>
            <div className="joi-label mb-2" style={{ color: 'var(--joi-text-3)' }}>Platform</div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <div className="joi-label mb-2" style={{ color: 'var(--joi-text-3)' }}>Language</div>
            ...
            <div>
              <div className="joi-label mb-2" style={{ color: 'var(--joi-text-3)' }}>Topic / Context</div>
              <input
                type="text"
                value={contextHint}
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-xl p-4" style={{ background: 'var(--joi-bg-3)', border: '1px solid var(--joi-border)' }}>
                <div className="flex items-center justify-between mb-2">
                  <span className="joi-label" style={{ color: 'var(--joi-text-3)' }}>Caption</span>
                  <button
