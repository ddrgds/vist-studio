...
export const SOUL_STYLES: SoulStyle[] = [
  ...
  { id: 'custom-cc-producthold', name: 'Product Hold', category: 'social', icon: '🧴' },
  { id: 'custom-cc-beforeafter', name: 'Before & After', category: 'social', icon: '↔️' },
  { id: 'custom-cc-reactionface', name: 'Reaction Face', category: 'social', icon: '😱' },
  { id: 'custom-cc-tutorial', name: 'Tutorial Pose', category: 'social', icon: '👩‍🏫' },
  { id: 'custom-cc-testimonial', name: 'Testimonial', category: 'social', icon: '💬' },
  { id: 'custom-cc-hauldisplay', name: 'Haul Display', category: 'social', icon: '🛍️' },
  { id: 'custom-cc-tastetest', name: 'Taste Test', category: 'social', icon: '😋' },
  { id: 'custom-cc-outfitspin', name: 'Outfit Spin', category: 'social', icon: '🔄' },
  { id: 'custom-cc-flatlay', name: 'Flat Lay Style', category: 'social', icon: '📐' },
  { id: 'custom-cc-phonecam', name: 'Phone to Camera', category: 'social', icon: '📱' },

  // ── Aesthetic / Vibra ──
  { id: 'custom-aes-cleangirl', name: 'Clean Girl', category: 'fashion', icon: '🧼', featured: true },
  { id: 'custom-aes-thatgirl', name: 'That Girl', category: 'fashion', icon: '🌿' },
  { id: 'custom-aes-softgirl', name: 'Soft Girl', category: 'fashion', icon: '🧸' },
  { id: 'custom-aes-baddie', name: 'Baddie', category: 'fashion', icon: '🔥', featured: true },
  { id: 'custom-aes-egirl', name: 'E-Girl', category: 'fashion', icon: '⛓️' },
  { id: 'custom-aes-darkfem', name: 'Dark Feminine', category: 'fashion', icon: '🖤' },
  { id: 'custom-aes-lightfem', name: 'Light Feminine', category: 'fashion', icon: '🤍' },
  { id: 'custom-aes-tomboy', name: 'Tomboy', category: 'fashion', icon: '🧢' },
  { id: 'custom-aes-mobwife', name: 'Mob Wife', category: 'fashion', icon: '🦊' },
  { id: 'custom-aes-vanilla', name: 'Vanilla Girl', category: 'fashion', icon: '🍦' },
];
