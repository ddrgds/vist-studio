...
export const SOUL_STYLES: SoulStyle[] = [
  ...
  { id: 'custom-fash-gothic-victorian', name: 'Gótico Victoriano', category: 'fashion', icon: '🕯️', hint: 'Victorian gothic fashion, black lace high-neck blouse or corseted dress, velvet choker with cameo pendant, long flowing sleeves with cuffs, jet black hair, dramatic pale makeup with dark lipstick, candle-lit cathedral or moody manor backdrop, deep blacks accented with burgundy or oxblood, romantic-macabre mood' },
  { id: 'custom-fash-gothic-romantic', name: 'Goth Romántico', category: 'fashion', icon: '🥀', hint: 'modern romantic goth fashion, soft black velvet slip dress or sheer lace top, layered silver jewelry with crosses or moons, smudged dark eye makeup, dried roses or ivy backdrop, melancholic dreamy mood, wearable everyday goth aesthetic' },
  { id: 'custom-fash-gothic-cyber', name: 'Cybergoth', category: 'fashion', icon: '⛓️', hint: 'cybergoth futuristic fashion, black PVC or vinyl corset top, fishnet sleeves, neon UV accents in violet or acid green, platform combat boots, blacklight-lit industrial club or neon-grid backdrop, sci-fi gothic fusion' },
  ...
  // ── Outfit packs (16) — specific looks with color hex codes ──
  { id: 'outfit-slip-satin', name: 'Slip Dress Satín', category: 'fashion', icon: '🥂', hint: 'silk satin slip dress, thin spaghetti straps, cowl neckline, midi length (hex: #F5E6CC champagne or #0A0A0A black), strappy heels, layered gold necklaces, dinner-out aesthetic, soft restaurant lighting' },
  { id: 'outfit-lbd-bodycon', name: 'LBD Bodycon', category: 'fashion', icon: '🍸', hint: 'fitted little black dress, bodycon silhouette knee-length, halter or square neckline (hex: #0A0A0A black), black stilettos, statement earrings, sleek hair, cocktail bar or rooftop event' },
  { id: 'outfit-mini-blacktie', name: 'Mini Black Tie', category: 'fashion', icon: '💋', hint: 'short black tie mini dress with sequins or structured silhouette (hex: #0A0A0A black with #C0C0C0 silver shimmer or #FFD37A gold), strappy stilettos, clutch, gala or formal party setting' },
  { id: 'outfit-blazer-oversize', name: 'Blazer Oversize', category: 'fashion', icon: '🧥', hint: 'oversized boyfriend blazer with rolled sleeves over crop top or bandeau (hex: #1A1A1A black blazer with #FFFFFF white tank or #FBC7D9 pink), bike shorts or low-rise jeans, sneakers or boots, off-duty model aesthetic' },
  { id: 'outfit-trench-moment', name: 'Trench Coat', category: 'fashion', icon: '🍂', hint: 'classic camel trench coat belted at waist (hex: #B89674 camel), opaque tights, ankle boots, sunglasses, autumn street style, foggy European street setting' },
  { id: 'outfit-coord-knit', name: 'Co-ord Tejido', category: 'fashion', icon: '🧶', hint: 'matching knit two-piece set, ribbed crop top and skirt or pants (hex: #F5E6CC cream, #B89674 camel, or #B91E1E rust red), cozy textured fabric, ankle boots, autumn coffee shop aesthetic' },
  { id: 'outfit-latex-club', name: 'Latex Club', category: 'fashion', icon: '✨', hint: 'shiny latex or PVC bodycon mini dress, glossy reflective fabric (hex: #B91E1E red, #0A0A0A black, or #FF00C8 hot pink), high heels, slicked back hair, dark club setting with neon accents' },
  { id: 'outfit-mesh-skirt', name: 'Mesh + Cuero', category: 'fashion', icon: '🕸️', hint: 'sheer mesh long-sleeve top over bandeau, leather mini skirt (hex: #0A0A0A black mesh and leather), platform boots, chunky silver jewelry, edgy night-out aesthetic, urban graffiti backdrop' },
  { id: 'outfit-crop-cargo', name: 'Crop + Cargo', category: 'fashion', icon: '🧢', hint: 'fitted crop top or sport bra and low-rise cargo pants (hex: #2C5530 olive cargo with #FFFFFF white top, or all black), sneakers, baseball cap, urban streetwear, parking lot or graffiti wall' },
  { id: 'outfit-tank-jeans', name: 'Tank + Jeans', category: 'fashion', icon: '👖', hint: 'fitted white ribbed tank top tucked into low-rise vintage jeans (hex: #FFFFFF white tank, #4A6FA5 vintage blue denim), brown belt, sneakers or cowboy boots, effortless model-off-duty look, NYC street style' },
  { id: 'outfit-sundress-flowy', name: 'Sundress Floral', category: 'fashion', icon: '🌼', hint: 'flowy floral sundress, midi or maxi length, ruffled hem (hex: pastel floral print on #FFFFFF white base), espadrille sandals, straw bag, golden hour vineyard or Mediterranean village backdrop' },
  { id: 'outfit-bralette-jeans', name: 'Bralette + Jeans', category: 'fashion', icon: '👚', hint: 'lace bralette as outerwear paired with high-waist baggy jeans (hex: #0A0A0A black or #F5E6CC nude bralette, #4A6FA5 medium wash jeans), gold layered necklaces, model-off-duty NYC aesthetic' },
  { id: 'outfit-knit-cardigan', name: 'Cardigan + Mini', category: 'fashion', icon: '🪡', hint: 'soft oversized chunky knit cardigan over bralette and high-waist mini skirt (hex: #F5E6CC cream cardigan, #FFFFFF tank, denim skirt), thigh-high socks, loafers, dark academia coffee shop' },
  { id: 'outfit-leather-pants', name: 'Leather Pants', category: 'fashion', icon: '🖤', hint: 'sleek leather pants with crop top or bodysuit (hex: #0A0A0A black leather, #FFFFFF white tank), heels, gold accessories, rock-and-roll meets clean girl aesthetic, urban evening setting' },
  { id: 'outfit-corset-jeans', name: 'Corset + Jeans', category: 'fashion', icon: '🦋', hint: 'structured boned corset top as going-out top with baggy low-rise jeans (hex: #FFFFFF white or #0A0A0A black corset with #4A6FA5 medium denim), gold body chain, going-out clubwear elevated aesthetic' },
  { id: 'outfit-monochrome-beige', name: 'Total Beige', category: 'fashion', icon: '🤎', hint: 'head-to-toe monochrome beige outfit, knit tank tucked into beige tailored pants or skirt (hex: #B89674 camel, #F5E6CC cream layered together), neutral pumps, modern minimalist aesthetic, white loft or gallery setting' },
  ...
  // ── Fashion (new) ──
  { id: 'fash-mob-wife', name: 'Mob Wife', category: 'fashion', icon: '🦊', hint: 'mob wife aesthetic, oversized fur coat, gold jewelry, big sunglasses, dark lip, espresso martini energy, Italian luxury' },
  { id: 'fash-clean-girl', name: 'Clean Girl', category: 'fashion', icon: '🧴', hint: 'clean girl aesthetic, slicked-back bun, gold hoops, dewy skin, neutral tones, minimal makeup, effortlessly polished' },
  { id: 'fash-corp-core', name: 'Corpcore', category: 'fashion', icon: '💼', hint: 'corporate core fashion, tailored blazer, pencil skirt or pressed trousers, briefcase, glass office building, power dressing' },
  { id: 'fash-western', name: 'Western / Cowboy', category: 'fashion', icon: '🤠', hint: 'modern western fashion, cowboy boots, denim, fringe jacket, cowboy hat, desert or ranch backdrop, Yellowstone aesthetic' },
  { id: 'fash-festival', name: 'Festival', category: 'fashion', icon: '🎪', hint: 'music festival fashion, crochet top, body glitter, flower crown, boho jewelry, Coachella vibes, golden hour desert' },
  { id: 'fash-matcha', name: 'Matcha Aesthetic', category: 'fashion', icon: '🍵', hint: 'sage green and cream palette, linen fabrics, minimalist clean aesthetic, matcha latte in hand, zen calm energy' },
  { id: 'fash-chrome', name: 'Chrome / Metallic', category: 'fashion', icon: '🪩', hint: 'head-to-toe metallic chrome outfit, silver or liquid metal fabric, futuristic runway, reflective surfaces, space-age glamour' },
  { id: 'fash-tomboy', name: 'Tomboy Chic', category: 'fashion', icon: '🧢', hint: 'oversized menswear on feminine frame, baggy jeans, snapback cap, sneakers, effortlessly cool androgynous style' },
  { id: 'fash-regency', name: 'Regencycore', category: 'fashion', icon: '👑', hint: 'Bridgerton-inspired regency fashion, empire waist dress, pearls, delicate gloves, English garden, romantic pastel palette' },
  { id: 'fash-cybery2k', name: 'Cyber Y2K', category: 'fashion', icon: '💎', hint: 'futuristic Y2K, metallic mini skirt, platform boots, LED accessories, holographic fabric, chrome sunglasses, nightclub' },
  { id: 'fash-dopamine', name: 'Dopamine Dressing', category: 'fashion', icon: '🌈', hint: 'bold clashing colors head to toe, maximalist color blocking, joyful and vibrant, every piece a different bright color' },
  { id: 'fash-tennis', name: 'Tennis Core', category: 'fashion', icon: '🎾', hint: 'tennis skirt, polo shirt, white sneakers, visor, preppy athletic style, tennis court backdrop, clean and sporty' },
  { id: 'fash-après-ski', name: 'Après-Ski', category: 'fashion', icon: '⛷️', hint: 'luxury ski lodge fashion, chunky knit sweater, fur-lined boots, cozy scarf, snowy mountain backdrop, hot cocoa, chalet vibes' },
  { id: 'fash-office-siren', name: 'Office Siren', category: 'fashion', icon: '🖊️', hint: 'office siren aesthetic, fitted pencil skirt, reading glasses on nose, silk blouse slightly unbuttoned, corporate but seductive' },
  { id: 'fash-coconut', name: 'Coconut Girl', category: 'fashion', icon: '🥥', hint: 'tropical island girl, shell jewelry, crochet bikini top, sarong, sun-bleached hair, turquoise ocean backdrop, island paradise' },

  // ── Spicy (new) ──
  { id: 'spicy-shower', name: 'Shower / Water', category: 'spicy', icon: '🚿', hint: 'water cascading over skin, shower or rain setting, wet hair clinging, droplets on body, steamy glass, sensual and fresh' },
  { id: 'spicy-golden-oil', name: 'Golden Oil', category: 'spicy', icon: '✨', hint: 'body glistening with golden oil, warm studio lighting, sculpted muscles highlighted, every curve catching light, luxurious skin' },
  { id: 'spicy-balcony', name: 'Hotel Balcony', category: 'spicy', icon: '🏨', hint: 'standing on hotel balcony in robe or lingerie, city skyline at night, champagne glass, penthouse suite, wind in hair' },
  { id: 'spicy-silk-bed', name: 'Silk Sheets', category: 'spicy', icon: '🛏️', hint: 'lying on silk satin sheets, soft champagne or burgundy tones, bedroom golden hour light, elegant and tasteful, magazine boudoir' },
  { id: 'spicy-paint', name: 'Body Paint', category: 'spicy', icon: '🎨', hint: 'artistic body paint covering skin, bold colors and patterns, paint drips and splatters, gallery setting, body as canvas' },
  { id: 'spicy-polaroid', name: 'Spicy Polaroid', category: 'spicy', icon: '📸', hint: 'intimate Polaroid photo aesthetic, slightly washed out, flash on skin, casual bedroom setting, authentic and personal' },
  { id: 'spicy-harness', name: 'Harness', category: 'spicy', icon: '⚫', hint: 'wearing leather body harness over clothing or skin, dark editorial, dramatic contrast lighting, fashion-forward edge' },
  { id: 'spicy-midnight', name: 'Midnight Swim', category: 'spicy', icon: '🌊', hint: 'swimming at night, moonlight on water and wet skin, dark pool or ocean, ethereal and mysterious, just emerging from water' },
  { id: 'spicy-fur', name: 'Faux Fur', category: 'spicy', icon: '🐻', hint: 'wearing only oversized faux fur coat, bare legs, luxurious texture against skin, warm lighting, decadent and cozy' },
  { id: 'spicy-gym', name: 'Gym Pump', category: 'spicy', icon: '💪', hint: 'post-workout pump, tight activewear, muscles defined, sweat glistening, gym mirrors and weights, powerful and athletic' },
  { id: 'spicy-window', name: 'Window Light', category: 'spicy', icon: '🪟', hint: 'standing by large window, natural light wrapping around body, sheer curtain, silhouette mixed with soft light, artistic and intimate' },
  { id: 'spicy-feathers', name: 'Feathers', category: 'spicy', icon: '🪶', hint: 'draped in loose feathers or feather boa, burlesque-inspired, soft plumes against bare skin, showgirl glamour' },
  { id: 'spicy-leather', name: 'All Leather', category: 'spicy', icon: '🖤', hint: 'head-to-toe leather outfit, pants and corset or jacket, dark edgy aesthetic, motorcycle or club vibes, dominance energy' },
  { id: 'spicy-tropical', name: 'Tropical Heat', category: 'spicy', icon: '🌺', hint: 'tropical paradise, minimal swimwear, lush jungle foliage, waterfall or beach, sun-drenched skin, island goddess' },
  { id: 'spicy-noir', name: 'Noir Seduction', category: 'spicy', icon: '🖤', hint: 'black and white film noir femme fatale, cigarette holder, stockings, high contrast shadows, venetian blinds, dangerous glamour' },
  ...
  // ── Sensual IG-style poses (12) — modern influencer / blonde aesthetic ──
  { id: 'pose-sensual-hipside', name: 'Mano en Cadera', category: 'spicy', icon: '💁', hint: 'one hand on hip, slight contrapposto with weight on back leg, hip pushed out, looking directly at camera with confident gaze, head slightly tilted, full body or 3/4 framing, IG influencer aesthetic' },
  { id: 'pose-sensual-overshoulder', name: 'Mirada Sobre Hombro', category: 'spicy', icon: '👀', hint: 'turned away from camera looking back over bare shoulder, hair swept to one side, soft side-glance with parted lips, exposed back or shoulder blade, intimate magazine pose' },
  { id: 'pose-sensual-hair', name: 'Jugando con Cabello', category: 'spicy', icon: '💇', hint: 'both hands lifted to hair, fingers running through long hair, head tilted back slightly, eyes closed or looking up, arms raised exposing waist and silhouette, IG model pose' },
  { id: 'pose-sensual-bedlying', name: 'Recostada en Cama', category: 'spicy', icon: '🛌', hint: 'lying on stomach on bed, propped up on elbows, legs bent up behind crossed at ankles, looking at camera with sultry expression, hair falling around face, golden afternoon light from window, intimate boudoir composition' },
  { id: 'pose-sensual-bedseated', name: 'Sentada en Cama', category: 'spicy', icon: '🛏️', hint: 'sitting on edge of bed with legs slightly apart, leaning forward with hands resting on thighs or behind on the bed, looking up at camera with parted lips, hair tousled, soft morning light, classic boudoir pose' },
  { id: 'pose-sensual-stretching', name: 'Estirando Brazos', category: 'spicy', icon: '🙆', hint: 'arms stretched overhead in luxurious morning stretch, back slightly arched, exposed midsection and waistline, eyes closed or half-shut, natural window light catching skin, candid intimate moment' },
  { id: 'pose-sensual-collarbone', name: 'Mano en Cuello', category: 'spicy', icon: '🤚', hint: 'one hand touching collarbone or neck, fingers spread softly against skin, head tilted exposing neck line, eyes lowered or looking aside, soft direct light highlighting clavicles and jaw, fashion magazine portrait' },
  { id: 'pose-sensual-crossedlegs', name: 'Piernas Cruzadas', category: 'spicy', icon: '🦵', hint: 'sitting elegantly with legs crossed at thighs, one hand resting on top knee, other arm draped over chair back or sofa, leaning back slightly, confident direct gaze, sophisticated lounge setting' },
  { id: 'pose-sensual-laydown', name: 'Tumbada de Lado', category: 'spicy', icon: '😌', hint: 'lying on side facing camera, head propped on bent arm, body forming an S-curve, other hand resting on hip or thigh, hair fanned out behind, soft natural light, magazine boudoir aesthetic' },
  { id: 'pose-sensual-mirroriPhone', name: 'Mirror Selfie iPhone', category: 'spicy', icon: '📱', hint: 'authentic mirror selfie taken with iPhone, phone covering part of face, standing in bathroom or bedroom with one hip popped out, free hand near hair or hip, slightly low angle, casual confident IG influencer aesthetic with phone visible in shot' },
  { id: 'pose-sensual-backarched', name: 'Espalda Arqueada', category: 'spicy', icon: '🪷', hint: 'kneeling or sitting with back arched dramatically, hands behind head or in hair, chest forward, head tilted back, exposing throat and silhouette, editorial fashion pose with dramatic studio lighting' },
  { id: 'pose-sensual-walkingaway', name: 'Caminando de Espaldas', category: 'spicy', icon: '🚶‍♀️', hint: 'walking away from camera in candid mid-stride, looking back over shoulder, hair swept aside, swaying motion captured naturally, hotel hallway or beach path setting, cinematic depth of field' },

  // ── Lingerie variants (10) — colors + cuts + settings ──
  { id: 'spicy-lenceria-encaje-negro', name: 'Encaje Negro', category: 'spicy', icon: '🖤', hint: 'matching delicate black lace bra and high-waist panties (hex: #0A0A0A black, sheer mesh inserts), elegant lingerie set with floral lace pattern, candle-lit bedroom or boudoir studio, dark moody lighting, classic boudoir editorial' },
  { id: 'spicy-lenceria-saten-crema', name: 'Satén Crema', category: 'spicy', icon: '🤍', hint: 'champagne satin slip and matching panties (hex: #F5E6CC champagne cream), silky smooth fabric catching light, soft morning bedroom light through sheer curtains, romantic feminine boudoir' },
  { id: 'spicy-lenceria-rojo', name: 'Rojo Pasión', category: 'spicy', icon: '❤️', hint: 'red lingerie set with garter belt and stockings (hex: #B91E1E deep red), sheer red robe loosely draped, dramatic warm lighting, velvet bed or chaise, cinematic passionate mood' },
  { id: 'spicy-lenceria-burdeos-victorian', name: 'Burdeos Victorian', category: 'spicy', icon: '🍷', hint: 'burgundy corset and high-waist boyshorts with lace trim (hex: #5B1A1A burgundy oxblood), velvet ribbons, Victorian gothic boudoir setting, candle-lit antique room, romantic-macabre aesthetic' },
  { id: 'spicy-lenceria-blanco-bridal', name: 'Blanco Nupcial', category: 'spicy', icon: '🤍', hint: 'pristine white lace lingerie set with ribbon bows (hex: #FFFFFF white, #FFF8E7 ivory accents), virginal and ethereal, sheer white veil or sheer robe, soft window light, fresh and clean aesthetic' },
  { id: 'spicy-lenceria-pastel-rosa', name: 'Rosa Coquette', category: 'spicy', icon: '🎀', hint: 'pink coquette lingerie with bow details and frilly trim (hex: #F5A8C5 blush pink), delicate satin and tulle, pink-themed bedroom with stuffed animals and roses, soft pastel aesthetic, Lana Del Rey coquette vibe' },
  { id: 'spicy-lenceria-deportiva', name: 'Sporty Bralette', category: 'spicy', icon: '💪', hint: 'athletic bralette and matching boyshort or cheeky brief (hex: heather grey or black), Calvin Klein sporty aesthetic, soft tracksuit pants pulled down at hip or off, casual morning bedroom, modern wellness IG aesthetic' },
  { id: 'spicy-lenceria-strappy', name: 'Strappy Negro', category: 'spicy', icon: '⛓️', hint: 'black multi-strap lingerie set, harness-style straps across torso and hips (hex: #0A0A0A jet black), edgy fashion-forward lingerie, dark studio or industrial setting, dramatic contrast lighting' },
  { id: 'spicy-lenceria-mesh-pink', name: 'Mesh Translúcido', category: 'spicy', icon: '🌸', hint: 'soft pink mesh slip dress lingerie, sheer translucent fabric (hex: #FBC7D9 baby pink, #FFFFFF accents), tasteful coverage with strategic opacity, soft window light, dreamy feminine bedroom' },
  { id: 'spicy-lenceria-thong-highwaist', name: 'Tanga Alta Vintage', category: 'spicy', icon: '👙', hint: 'high-waist vintage thong panties and matching balconette bra (hex: #1A1A1A black), retro 60s pinup aesthetic, polka dots or solid colors, vintage boudoir studio with art deco accents' },

  // ── Bikini variants (10) — cuts + settings + colors ──
  { id: 'spicy-bikini-brazilian-thong', name: 'Brazilian Thong', category: 'spicy', icon: '🇧🇷', hint: 'tiny brazilian thong bikini with minimal triangle top (hex: bright tropical color like #FF6B35 sunset orange or #1E88E5 ocean blue), Rio de Janeiro beach setting, sun-kissed tanned skin, golden hour light, confident sun-worshipper pose' },
  { id: 'spicy-bikini-microbikini', name: 'Microkini Neón', category: 'spicy', icon: '⚡', hint: 'tiny microkini with thin string ties (hex: #FF00C8 hot pink neon or #00F0FF electric cyan), minimal coverage, poolside or balcony setting at sunset, glistening oiled skin, bold confident pose' },
  { id: 'spicy-bikini-onepiece-cheeky', name: 'One-Piece Cheeky', category: 'spicy', icon: '🩱', hint: 'one-piece swimsuit with deep V neckline and high-cut cheeky bottom (hex: #B91E1E lifeguard red or #0A0A0A black), exposing hips and legs, Baywatch aesthetic or modern beach editorial, sandy beach with waves' },
  { id: 'spicy-bikini-triangle-string', name: 'Triángulo String', category: 'spicy', icon: '🔺', hint: 'classic triangle bikini top and string-tie bottom (hex: #FFFFFF white, #FFE8A3 buttery yellow, or #FBC7D9 baby pink), tropical Hawaiian beach, palm trees, surfboard, beach babe aesthetic, sun-drenched skin' },
  { id: 'spicy-bikini-vintage-highwaist', name: 'Bikini Vintage Alto', category: 'spicy', icon: '🌺', hint: 'high-waisted vintage 50s bikini with halter neck top (hex: #D9344A red, #1A1A1A black, polka dot patterns), pinup aesthetic, retro Miami pool or beach club setting, classic Hollywood glamour' },
  { id: 'spicy-bikini-crochet-boho', name: 'Crochet Boho', category: 'spicy', icon: '🌻', hint: 'handmade crochet bikini in earth tones (hex: #B89674 camel, #7A5A3F warm brown, ivory threads), boho festival aesthetic, beaded layered necklaces, tropical jungle or remote beach, golden hour, free-spirit hippie vibe' },
  { id: 'spicy-bikini-sport', name: 'Bikini Deportivo', category: 'spicy', icon: '🏐', hint: 'athletic sport bikini with thicker straps, racerback or zip front top (hex: #0A0A0A black, #1E88E5 royal blue, or coral), volleyball or surf aesthetic, action pose mid-jump or running, beach competition setting, fit and powerful' },
  { id: 'spicy-bikini-tropical-print', name: 'Tropical Estampado', category: 'spicy', icon: '🌴', hint: 'tropical print bikini with floral or palm pattern (hex: #FF6B35 hibiscus orange, #1E88E5 turquoise base, #2C5530 green leaves), Bali or Tulum beach setting, infinity pool with overflow into ocean, exotic vacation aesthetic' },
  { id: 'spicy-bikini-mesh-coverup', name: 'Bikini + Mesh', category: 'spicy', icon: '🕸️', hint: 'black bikini under sheer mesh long-sleeve coverup (hex: #0A0A0A black, sheer black mesh), beach to bar transition look, sunset beach club, gold body chain accent, sophisticated beach aesthetic' },
  { id: 'spicy-bikini-noir-lago', name: 'Black Bikini Lago', category: 'spicy', icon: '🏞️', hint: 'sleek black bikini with chrome or gold hardware accents (hex: #0A0A0A black, #FFD37A gold rings), standing in pristine mountain lake or infinity pool, cinematic wide shot, minimalist luxury aesthetic, cold blue water against tanned skin' },
];

/**
 * IDs of presets that are gated to Modo Creator (Spicy / sensual).
